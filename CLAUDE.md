...
- `pipeline_runs` — **LEGADO** (log de orquestração; sem consumidor agora; removível)
...
2. **`pipeline_runs`**: tabela legada de orquestração; remover quando conveniente.
3. **`escopo.md`** (raiz): documento antigo do projeto Premier League; obsoleto.
